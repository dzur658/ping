...
DEFAULT_ADAPTER_DIR = "./dataset-creation/adapters"  # Current directory
...
for msg in ensure_think_tag(st.session_state.messages):
...
if prompt := st.chat_input("Type your message here..."):
    ...
    with st.chat_message("assistant"):
        ...
        conversation_history = [{"role": "system", "content": system_prompt}] + ensure_think_tag(st.session_state.messages)
        ...
        message_placeholder.markdown("<think>" + response)
    
    # D. Save Assistant Response to History
    st.session_state.messages.append({"role": "assistant", "content": "<think>" + response})
