...
st.set_page_config(page_title="GGUF LoRA Tester (Chat Completions)", layout="wide")
...
def construct_device_context(device_str, knowledge_base=KNOWLEDGE_BASE, val_path=VAL_PATH):
    ...
    try:
        ...
        raise ValueError(f"Error loading validation prompt: {e}")
    ...
    try:
        ...
        raise ValueError(f"Error accessing knowledge base: {e}")

    # Return the exact array format expected by the chat/completions endpoint
    return [
...
if prompt := st.chat_input("Type your message here..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            # Reverted to the highly stable chat.completions endpoint
