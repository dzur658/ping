...
async def search_and_parse_web(query: str, searxng_url: str=SEARXNG_URL, max_results: int=MAX_RESULTS_TO_PARSE) -> str:
    """
    ...
    for text, url in parsed_results:
        if text:
            ...
            final_output.append(f"<begin_page>\n<source url={url} />\n{text}\n\n" + "\n</end_page>" + "\n")
